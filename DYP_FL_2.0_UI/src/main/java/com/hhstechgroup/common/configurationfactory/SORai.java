 ...
 */
public class SORai extends Configuration {
    ...
    //
    //******************************************************************************************************************
    private static final String REQUEST_ADDITIONAL_INFO_ENABLE_AUTO_DENY_SWITCH = "Enable Auto Deny Switch_true_//input[@aria-label='Enable Auto Deny Switch']";
    private static final String REQUEST_ADDITIONAL_INFO_1ST_NOTIFICATION_DAYS = "Reminder 1st Notification_3_//div[contains(text(),'1st notification')]/../div[2]/span[1]";
    private static final String REQUEST_ADDITIONAL_INFO_2ND_NOTIFICATION_DAYS = "Reminder 2nd Notification_10_//div[contains(text(),'2nd notification')]/../div[2]/span[1]";
    private static final String REQUEST_ADDITIONAL_INFO_3RD_NOTIFICATION_DAYS = "Reminder 3rd Notification_30_//div[contains(text(),'3rd notification')]/../div[2]/span[1]";
     ...
     */
    public void verifyRaiSO(WebDriver driver, SoftAssert softAssert) {
        ...
        Reports.log("\n********************************************************");
        Reports.log("Request Additional Information Configuration");
        Reports.log("********************************************************");
        ...
        for (ArrayList<String> strings : parameterList) {
            ...
            switch (configurationString) {
                case REQUEST_ADDITIONAL_INFO_ENABLE_AUTO_DENY_SWITCH:
                    booleanTextCompare(driver, xpathParse, expectedValueParse, configurationNameParse, softAssert);
                    break;
                case REQUEST_ADDITIONAL_INFO_1ST_NOTIFICATION_DAYS:
                case REQUEST_ADDITIONAL_INFO_2ND_NOTIFICATION_DAYS:
                case REQUEST_ADDITIONAL_INFO_3RD_NOTIFICATION_DAYS:
    ...
    /**
     * This method builds an Arraylist of XPath/Expected Values used by verifyRaiSO()
     *
     * @return parameterList
     */
    private ArrayList<ArrayList<String>> buildParameterList() {
            ArrayList<ArrayList<String>> parameterList = new ArrayList<>();
            parameterList.add(new ArrayList<>(List.of(REQUEST_ADDITIONAL_INFO_ENABLE_AUTO_DENY_SWITCH)));
            parameterList.add(new ArrayList<>(List.of(REQUEST_ADDITIONAL_INFO_1ST_NOTIFICATION_DAYS)));
            parameterList.add(new ArrayList<>(List.of(REQUEST_ADDITIONAL_INFO_2ND_NOTIFICATION_DAYS)));
            parameterList.add(new ArrayList<>(List.of(REQUEST_ADDITIONAL_INFO_3RD_NOTIFICATION_DAYS)));
            return parameterList;
        }
    }
