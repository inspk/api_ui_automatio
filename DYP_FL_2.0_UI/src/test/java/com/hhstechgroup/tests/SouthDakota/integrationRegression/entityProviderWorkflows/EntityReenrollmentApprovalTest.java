...
public class EntityReenrollmentApprovalTest extends BaseClassUI {
    ...
    public void reEnrollApprovalEntityEnrollment(String testEnvironment, String applicationType, String firstName, String lastName, String newEmail, String trackingNum) throws Exception {


        //Reset the enrollmentType written to Provider Info sheet
        applicationType = Data.ENTITY_RE_ENROLLMENT;
        ...
        System.out.println(reEnrollment_RequestID);
