...
public class FloridaMedicaidProviderForEntity extends BaseClassUI {
    ...
    @Test(dataProvider = "getEntityProviderNameWithStatusSubmitted",
            ...
            groups = {"EntityEnrollmentEnrolmentSection"})
    public void EntityEnrollmentEnrolmentSection(String testEnvironment,String firstName, String lastName, String trackingId) throws IOException {

        Reports.log("Entity Enrollment Section");
...
//        iuEnrollmentPage.searchproviderByEnrollmentType(IUEnrollmentPage.PEMEnrollment);
    ...
    @Test(dataProvider = "getEntityProviderNameWithStatusSubmitted",
            dataProviderClass = DataProviderForProviderInfo.class,
            dependsOnGroups = {"EntityEnrollmentEnrolmentSection"},
            groups = {"EntityEnrollemntProviderSection"})
    public void EntityEnrollemntProviderSection(String testEnvironment,String firstName, String lastName, String trackingId) throws IOException {

        Reports.log("Entity Enrollment Provider Section");
        // Login Application as an internal user
        loginPage.signInToApp(internalUserEmail, internalUserPassword);
