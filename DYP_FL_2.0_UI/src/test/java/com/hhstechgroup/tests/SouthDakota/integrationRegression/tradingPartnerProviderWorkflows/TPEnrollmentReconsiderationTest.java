...
public class TPEnrollmentReconsiderationTest extends BaseClassUI {
    ...
    @Test(dataProvider = "getTPProviderNameEmailWithStatusDenied", dataProviderClass = DataProviderForProviderInfo.class)
    public void reconsiderApprovalTPEnrollment(String testEnvironment, String applicationType, String firstName, String lastName, String providerEmailId, String trackingNum) throws Exception {
        ...
        applicationType = Data.TRADING_PARTNER_RECONSIDERATION;
