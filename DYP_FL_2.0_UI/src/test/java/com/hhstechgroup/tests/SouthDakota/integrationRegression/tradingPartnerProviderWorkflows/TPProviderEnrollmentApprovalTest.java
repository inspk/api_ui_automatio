...
public class TPProviderEnrollmentApprovalTest extends BaseClassUI {
    ...
    public void approvalAndVerifyingTPEnrollment(String testEnvironment, String testEmailAccount, String enrollmentType,
