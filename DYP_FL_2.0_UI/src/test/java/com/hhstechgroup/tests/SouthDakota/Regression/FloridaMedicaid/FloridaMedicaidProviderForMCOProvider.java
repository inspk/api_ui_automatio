...
public class FloridaMedicaidProviderForMCOProvider extends BaseClassUI {
    ...
    @Test(dataProvider = "getProviderForMCOProvNameEmailStatusSubmitted",
            ...
            dependsOnGroups = {"verifyAndSetFloridaMedicaidProviderIdStatus"},
            groups = {"MCOEnrollmentEnrolmentSection"})
    public void MCOEnrollmentEnrolmentSection(String testEnvironment,String firstName, String lastName, String emailID, String trackingNum) throws IOException {

        Reports.log("MCO Enrollment Enrollment Section");
...
//        iuEnrollmentPage.searchproviderByEnrollmentType(IUEnrollmentPage.PEMEnrollment);
    ...
    @Test(dataProvider = "getProviderForMCOProvNameEmailStatusSubmitted",
            dataProviderClass = DataProviderForProviderInfo.class,
            dependsOnGroups = {"MCOEnrollmentEnrolmentSection"},
            groups = {"MCOEnrollemntProviderSection"})
    public void MCOEnrollemntProviderSection(String testEnvironment,String firstName, String lastName, String emailID, String trackingNum) throws IOException {

        Reports.log("MCO Enrollment Provider Section");
...
//        providersPage.searchproviderByEnrollmentType(IUEnrollmentPage.PEMEnrollment);
        ...
        //fetching the datas and storing it in variables
        Data.baseproviderId = driver.findElement(floridaMedicaidProviderIDProvider.BaseProviderId).getText();
        Data.locationproviderID = driver.findElement(floridaMedicaidProviderIDProvider.LocationProviderID).getText();
        status = driver.findElement(floridaMedicaidProviderIDProvider.StatusOfApplication).getText();

        //writing it to excel and reading it
        excel.writeData(baseproviderId, Data.locationproviderID, status);
        excel.readExcel();
