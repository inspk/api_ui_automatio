...
public class BillingEnrollmentApprovalTest extends BaseClassUI {
...
5. Final Status Change verification (Approve the application)*/
    ...
    public void approvingAndVerifyingBillingEnrollment(String testEnvironment, String testEmailAccount,String enrollmentType,
