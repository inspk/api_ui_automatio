...
/**
 * This test class verifies the submission of a Group enrollment.
 */
public class GroupProviderRegistrationAndSubmissionTest extends BaseClassUI {
     ...
     * into DyP as the registered provider, creates and submits a Group enrollment, logs out as the registered Provider
     * and writes the enrollment information to ProviderInfo.xlsx.
     *
     * @param testEmailAccount Alias Provider email account
     * @param enrollmentType Type of enrollment that created and submitted
     * @param newEmail Provider registration email address
     * @param firstName Provider First Name
     * @param lastName Provider Last Name
     * @param paymentOption Payment Option type
     * @param medicareParticipant Answer to enrollment Medicare question
     * @param taxonomyCategory Enrollment Taxonomy Category
     * @param taxonomy Enrollment Taxonomy
     * @throws Exception
     */
    @Video
    @Test(dataProvider = "Enrollment Application Data")
    public void registerAndSubmitGroupEnrollment (String testEnvironment, String testEmailAccount, String enrollmentType, String newEmail,
