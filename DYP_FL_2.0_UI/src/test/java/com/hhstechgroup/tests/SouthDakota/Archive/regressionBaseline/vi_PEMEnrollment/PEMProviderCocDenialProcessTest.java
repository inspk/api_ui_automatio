...
/**
 * This method contains a test which uses a data provider to get an approved PEM and creates and denies an identifying information CoC
 */
public class PEMProviderCocDenialProcessTest extends BaseClassUI {
     ...
     * and clears middle name filed and sends a random name and submits and store the tracking number. Then logs in as an
