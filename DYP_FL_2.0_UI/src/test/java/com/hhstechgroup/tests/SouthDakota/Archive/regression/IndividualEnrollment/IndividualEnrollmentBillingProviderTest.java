...
public class IndividualEnrollmentBillingProviderTest extends BaseClassUI {
    ...
    public void enrollIndividualAsBillingProvider(String testEnvironment, String testEmailAccount,String enrollmentType,
       ...
       // providerEnrollingPage.fillInMedicaidPaymentIdentifyingInformation("Yes");
        ...
        providerEnrollingPage.fillInProviderIdentifiersSection(medicareParticipant, npi, enrollmentType, taxonomyCategory);
