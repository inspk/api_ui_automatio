...
public class ServicingEnrollmentRetroactiveApprovalTest extends BaseClassUI {
...
/*    Submission of the application (with request of Enrollment date in past) and status verification on Provider Side
    ...
    @Video
    @Test(dataProvider = "Enrollment type", groups =  {"ApprovingBillingProvider"})
    public void retroactivelyApprovingAndVerifyingServicingEnrollment(String testEnvironment, String testEmailAccount,String enrollmentType,
        ...
        requestSubmission.submitEnrollment(testEnvironment,enrollmentType,providerEmailId, providerEmailPassword, firstName,
                lastName,enrollmentFormElements);
