...
public class IndividualEnrollment extends BaseClassUI {
...
"[Answer to the question, are you an enrolled Medicare Provider? (Yes or No)]"}*/
                ...
                {testEnvironment,testEmailAccount,Data.individualApplication, sdhomePage.generateEmail(providerEmailPrefix, "gmail.com"), sdhomePage.generateFirstName(), sdhomePage.generateLastName(), "Approved", "Offline", 1, "No", Data.specialityInterpreter, Data.interpreterTaxonomy},
        };
    }
