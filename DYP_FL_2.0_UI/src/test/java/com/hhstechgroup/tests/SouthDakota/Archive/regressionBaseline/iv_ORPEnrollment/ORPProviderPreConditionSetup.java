...
/**
 * This test class sets the Systems Option configuration for orp Provider.
 */


public class ORPProviderPreConditionSetup extends BaseClassUI {

    String providerType = "Ordering/Referring/Prescribing" ;

    /**
     * This test method logins as Internal user and sets the Systems Option configuration for ORP Provider as,
     * 1 Approver and 0 Reviewer for Enrollment, Re-Enrollment, Revalidation, CoC, Appeal and SiteVisits
     */
    @Test
    public void orpProviderPreConditionSetupTest() {
