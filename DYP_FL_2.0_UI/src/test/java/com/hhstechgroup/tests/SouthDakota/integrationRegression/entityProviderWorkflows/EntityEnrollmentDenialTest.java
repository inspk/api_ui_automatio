...
public class EntityEnrollmentDenialTest extends BaseClassUI {
...
5. Final Status Change verification (Approve the application)*/
    ...
    @Video
    @Test(dataProvider = "Enrollment type", groups =  {"DenyingEntityProvider"})
    public void denyingAndVerifyingEntityEnrollment(String testEnvironment, String testEmailAccount,String enrollmentType,
