...
/**
 * This test class verifies the submission of a Group enrollment with In-State payment fee verification and a Group
 * enrollment with Out Of State payment fee verification.
 */
public class GroupProviderPaymentFeeVerificationTest extends BaseClassUI {
    String npi;
     ...
     * into DyP as the registered provider, creates and submits a Group enrollment with In-State Fee verification,
    ...
    public void instatePaymentFeesVerificationForGroupPrvdr (String testEnvironment,String testEmailAccount,String enrollmentType, String newEmail, String firstName, String lastName,
        ...
        enrollmentPageProvider.verifyPaymentDetails(Data.inStateEnrollmentFeeForGroup);
    ...
    /**
     * This test method deletes existing test emails, registers a new Provider, confirms the registration email, logs
     * into DyP as the registered provider, creates and submits a Group enrollment with Out of state Fee verification,
     * logs out as the registered Provider and writes the enrollment information to ProviderInfo.xlsx.
     *
     * @param testEmailAccount
     * @param enrollmentType
    ...
    @Video
    @Test(dataProvider = "Enrollment Application Data")
    public void outStatePaymentFeesVerificationForGroupPrvdr (String testEnvironment, String testEmailAccount, String enrollmentType, String newEmail, String firstName, String lastName,
                                                            String paymentOption, String medicareParticipant, String taxonomyCategory, String taxonomy) throws Exception {
        /*
         Provider operations:
         Fill in required sections and fields
        ...
        //Payment Section
        enrollmentPageProvider.fillInPaymentSection(enrollmentType, paymentOption);
        enrollmentPageProvider.verifyPaymentDetails(Data.outStateEnrollmentFeeForGroup);
