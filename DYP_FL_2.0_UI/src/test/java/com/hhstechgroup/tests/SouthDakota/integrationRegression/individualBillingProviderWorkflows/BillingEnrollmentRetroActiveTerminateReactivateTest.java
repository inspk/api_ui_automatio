...
public class BillingEnrollmentRetroActiveTerminateReactivateTest extends BaseClassUI {

    /**
     * This test class verifies the Trading Partner Enrollment approval Retroactively, terminate, reactivate workflow
     */
    ...
    public Object[][] testSearchFeature(ITestContext context) {
        ...
        return new Object[][]{
                {testEnvironment, testEmailAccount, Data.BILLING_PROVIDER,
                        ...
                        HomePage.generateFirstName(), HomePage.generateLastName(), HomePage.changeYearAndDayInCurrentDate(0, 0, -30)},
        };
    }
    ...
    public void terminateAndReactivateBillingProvider(String testEnvironment, String testEmailAccount, String enrollmentType,
        ...
        requestStatusChange.providerStatusChange(enrollmentType,internalUserEmail,internalUserPassword,
                firstName, lastName, trackingId, providerEmailId, providerEmailPassword, Data.TEXT_TERMINATE, enrollmentFormElements);

        requestStatusChange.providerStatusChange(enrollmentType,internalUserEmail,internalUserPassword,
                firstName, lastName, trackingId, providerEmailId, providerEmailPassword, Data.APPLICATION_STATUS_REACTIVATE_TERMINATED,enrollmentFormElements );
