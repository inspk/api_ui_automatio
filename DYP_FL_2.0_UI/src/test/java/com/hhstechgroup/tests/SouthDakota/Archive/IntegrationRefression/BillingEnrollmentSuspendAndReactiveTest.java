...
public class BillingEnrollmentSuspendAndReactiveTest extends BaseClassUI {
    ...
    public void suspendReactivateBillingProvider(String testEnvironment, String applicationType, String firstName, String lastName,
