...
public class PEMEnrollingTradingPartnerProviderAndApprove extends BaseClassUI {
    ...
    public Object[][] testSearchFeature(ITestContext context) {
        ...
        return new Object[][]{
                {testEnvironment,Data.TRADING_PARTNER,
    ...
    @Video
    @Test(dataProvider = "Enrollment type", groups =  {"pemEnrollingTradingPartnerProvider"}, dependsOnGroups = {"ApprovePEMProvider"}
    )
    public void pemEnrollingTradingPartnerProvider(String testEnvironment,String enrollmentType,
