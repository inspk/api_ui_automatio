...
public class ServicingProviderReconsiderationApprovalTest extends BaseClassUI {
    ...
    @Video
    @Test(dependsOnGroups = "DenyingServicingProvider", dataProvider = "getServicingProviderNameAndEmailWithStatusDenied", dataProviderClass = DataProviderForProviderInfo.class)
    public void reconsiderApprovalServicingEnrollment(String testEnvironment, String applicationType, String firstName, String lastName, String providerEmailId, String trackingNum) throws Exception {
        ...
        applicationType = Data.SERVICING_PROVIDER_RECONSIDERATION;

        //Submit the Reconsideration
        requestSubmission.submitReconsideration(testEnvironment,applicationType, firstName, lastName, providerEmailId,providerEmailPassword, Data.APPLICATION_STATUS_SUBMITTED);
        ...
        requestStatusChange.reconsiderationStatusChange(testEnvironment, environmentUrl, applicationType,
                ...
                firstName, lastName, reconsideration_RequestID, providerEmailId,providerEmailPassword, Data.ApplicationStatusApprove);
