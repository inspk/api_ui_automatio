...
public class TPEnrollmentRetroActiveTerminateReactivateTest extends BaseClassUI {
    ...
    public void terminateAndReactivateTPProvider(String testEnvironment, String testEmailAccount, String enrollmentType,
