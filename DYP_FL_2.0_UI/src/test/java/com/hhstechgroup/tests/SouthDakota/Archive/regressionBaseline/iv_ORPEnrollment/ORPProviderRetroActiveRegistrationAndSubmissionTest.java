...
/**
 * This class contains a test which uses a data provider to register a new Provider, Creates and submits an ORP enrollment retroactively.
 */
public class ORPProviderRetroActiveRegistrationAndSubmissionTest extends BaseClassUI {
    String npi;
    String zipCode;
    ...
    /**
     * This method registers a new Provider, creates and submits an ORP enrollment. The flow is first deletes all
     * the exiting emails in gmail, opens registration page and fills all the fields. Opens gmail and clicks on
     * registration link and confirm. Logs in with the email and selects the enrollment type (ORP enrollment) and
     * completes all the sections including the "Request Retroactive Adjustment". clicks on yes to the question
     ...
     */
    @Video
    @Test(dataProvider = "Enrollment type", groups =  {"RetroActiveRegisterAndSubmitORPEnrollment"}, priority = 0)
