...
public class FloridaMedicaidProviderForIndividual extends BaseClassUI {
    ...
    @Test(dataProvider = "getIndProviderNameAndEmailWithStatusPendingReview",
            ...
            groups = {"IndividualEnrollmentEnrolmentSection"})
    public void IndividualEnrollmentEnrolmentSection(String testEnvironment,String firstName, String lastName, String emailID, String trackingNum) throws IOException {

        Reports.log("Individual Enrollment Enrollment Section");
...
//        iuEnrollmentPage.searchproviderByEnrollmentType(IUEnrollmentPage.PEMEnrollment);
    ...
    @Test(dataProvider = "getIndProviderNameAndEmailWithStatusPendingReview",
            dataProviderClass = DataProviderForProviderInfo.class,
            dependsOnGroups = {"IndividualEnrollmentEnrolmentSection"},
            groups = {"IndividualEnrollemntProviderSection"})
    public void IndividualEnrollemntProviderSection(String testEnvironment,String firstName, String lastName, String emailID, String trackingNum) throws IOException {

        Reports.log("Individual Enrollment Provider Section");
        // Login Application as an internal user
        loginPage.signInToApp(internalUserEmail, internalUserPassword);
