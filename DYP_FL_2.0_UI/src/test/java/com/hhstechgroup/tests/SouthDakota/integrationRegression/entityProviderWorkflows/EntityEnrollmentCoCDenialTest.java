...
public class EntityEnrollmentCoCDenialTest extends BaseClassUI {
    ...
    public void denialAndVerifyingEntityCoC(String testEnvironment, String enrollmentType, String firstName, String lastName, String provideEmailID, String trackingId) throws Exception {
