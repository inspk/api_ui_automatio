...
/**
 * This test class verifies the submission of a retroactive adjustment Facility enrollment.
 */
@Listeners(VideoListener.class)
public class FacilityProviderRetroActiveRegistrationAndSubmissionTest extends BaseClassUI {
    String npi;
    String zipCode;
     ...
     * into DyP as the registered provider, creates and submits a Facility enrollment (retroactive adjustment), logs out
     ...
     */
    @Video
    @Test(dataProvider = "Enrollment Application Data", groups =  {"RetroActiveRegisterAndSubmitFacilityEnrollment"}, priority = 0)
