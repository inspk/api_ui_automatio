...
public class ServicingEnrollmentDenialTest extends BaseClassUI {
...
5. Final Status Change verification (Approve the application)*/
    ...
    @Video
    @Test(dataProvider = "Enrollment type", groups =  {"DenyingServicingProvider"}
          ,dependsOnGroups = {"ApprovedEntityProvider"}
    )
    public void denyingAndVerifyingServicingEnrollment(String testEnvironment, String testEmailAccount,String enrollmentType,
