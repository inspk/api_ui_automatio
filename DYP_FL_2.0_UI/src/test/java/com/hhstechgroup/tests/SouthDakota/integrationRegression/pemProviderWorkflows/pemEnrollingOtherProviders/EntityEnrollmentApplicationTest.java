...
public class EntityEnrollmentApplicationTest extends BaseClassUI {
...
//    protected EnrollmentFormElements enrollmentFormElements ;
    ...
    @Video
    @Test(dataProvider = "Enrollment type", groups =  {"EntityProviderApproved"})
    public void approvingAndVerifyingEntityEnrollment(String testEnvironment, String testEmailAccount,String enrollmentType,
