...
public class BillingEnrollmentRetroActiveSuspendReactivateTest extends BaseClassUI {

    /**
     * This test class verifies the Billing Enrollment approval Retroactively, suspend, reactivate workflow
     */
    ...
    public void suspendAndReactivateBillingProvider(String testEnvironment, String testEmailAccount, String enrollmentType,
