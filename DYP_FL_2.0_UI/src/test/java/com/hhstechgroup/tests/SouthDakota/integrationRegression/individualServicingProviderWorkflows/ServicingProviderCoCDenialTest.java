...
public class ServicingProviderCoCDenialTest extends BaseClassUI {
    ...
    public void denialAndVerifyingServicingCoC(String testEnvironment, String enrollmentType, String firstName, String lastName, String provideEmailID, String trackingId) throws Exception {
        String[] categoryList = {Data.COC_ENROLLMENT_DATA_SELECT_CHECKBOX_OWNERSHIP};
