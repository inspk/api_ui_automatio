...
public class PEMEnrollingBillingProviderAndApprove extends BaseClassUI {
    ...
    public Object[][] testSearchFeature(ITestContext context) {
        ...
        return new Object[][]{
                {testEnvironment,Data.BILLING_PROVIDER,
    ...
    public void pemEnrollingBillingProvider(String testEnvironment,String enrollmentType,
