...
public class BillingEnrollmentRAITest extends BaseClassUI {
...
5. Final Status Change verification (Approve the application)*/
    ...
    public void approveAnRAIForBillingProvider(String testEnvironment, String testEmailAccount,String enrollmentType,
