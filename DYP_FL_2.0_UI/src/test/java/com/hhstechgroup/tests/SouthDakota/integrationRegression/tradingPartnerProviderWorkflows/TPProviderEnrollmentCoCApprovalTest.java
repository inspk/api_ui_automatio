...
public class TPProviderEnrollmentCoCApprovalTest extends BaseClassUI {
    ...
    public void approvalAndVerifyingTPCoC(String testEnvironment, String enrollmentType, String firstName,String lastName, String provideEmailID, String trackingNum) throws Exception {

        //Define a list of the tabs to be selected
        String[] categoryList = {Data.COC_ENROLLMENT_DATA_SELECT_CHECKBOX_IDENTIFYING,Data.COC_ENROLLMENT_DATA_SELECT_CHECKBOX_CLASSIFICATION};
