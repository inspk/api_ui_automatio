...
public class CredentialingVerificationTestForIndividual extends BaseClassUI {
    ...
    @Test(dataProvider = "getIndBillingProviderNameWithStatusSubmitted",
            ...
            dependsOnGroups = "ProviderindicatorForEnrollments", groups = "credentialingForEntity"
    )
    public void credentialingForIndividual(String testEnvironment, String firstName, String lastName, String trackingId) throws IOException {
