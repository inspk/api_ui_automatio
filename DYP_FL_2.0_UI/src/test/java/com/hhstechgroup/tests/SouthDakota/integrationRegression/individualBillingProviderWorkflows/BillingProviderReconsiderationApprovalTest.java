...
public class BillingProviderReconsiderationApprovalTest extends BaseClassUI {
    ...
    @Video
    @Test(dataProvider = "getBillingProviderNameAndEmailWithStatusDenied", dataProviderClass = DataProviderForProviderInfo.class, dependsOnGroups = "DenyingBillingProvider")
    public void reconsiderApprovalBillingEnrollment(String testEnvironment, String applicationType, String firstName, String lastName, String providerEmailId, String trackingNum) throws Exception {
        ...
        applicationType = Data.BILLING_PROVIDER_RECONSIDERATION;
