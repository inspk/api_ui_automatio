...
public class BillingEnrollmentRetroactiveApprovalTest extends BaseClassUI {
...
/*    Submission of the application (with request of Enrollment date in past) and status verification on Provider Side
    ...
    public void retroactivelyApprovingAndVerifyingBillingEnrollment(String testEnvironment, String testEmailAccount,String enrollmentType,
