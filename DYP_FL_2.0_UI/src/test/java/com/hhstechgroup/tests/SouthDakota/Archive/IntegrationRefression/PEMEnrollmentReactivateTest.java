...
public class PEMEnrollmentReactivateTest extends BaseClassUI {

    protected String providerInfoSheet = "ProviderInfo.xlsx";
    ExcelWrite excel = new ExcelWrite(providerInfoSheet, 0);

    /**
     * This test reactivates a terminated PEM Provider.
     *
    ...
    @Video
    @Test(dataProvider = "getPEMProviderNameEMailTypeTerminated", dataProviderClass = DataProviderForProviderInfo.class)
    public void terminateReactivatePEMProvider(String testEnvironment, String applicationType, String firstName, String lastName,
