...
public class TPEnrollmentRetroActiveSuspendReactivateTest extends BaseClassUI {

    /**
     * This test class verifies the Trading Partner Enrollment approval Retroactively, suspend, reactivate workflow
     */
    ...
    public void suspendAndReactivateTPProvider(String testEnvironment, String testEmailAccount, String enrollmentType,
