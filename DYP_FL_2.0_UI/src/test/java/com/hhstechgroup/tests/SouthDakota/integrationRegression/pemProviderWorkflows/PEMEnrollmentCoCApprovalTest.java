...
public class PEMEnrollmentCoCApprovalTest extends BaseClassUI {

    protected String providerInfoSheet = "ProviderInfo.xlsx";

    /**
     * This test creates a CoC for an active Provider and approves it
     *
    ...
    public void approvePEMCoC(String testEnvironment, String enrollmentType, String firstName, String lastName,
