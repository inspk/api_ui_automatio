...
public class ProviderIndicatorTestPEM extends BaseClassUI {


    @Video
    @Test(dataProvider = "getPEMProviderNameEmailWithStatusSubmitted",
            dataProviderClass = DataProviderForProviderInfo.class,
            dependsOnGroups = {"PEMEnrollemntProviderSection"},
            groups = {"ProviderindicatorForEnrollments"})


    public void ProviderindicatorForEnrollments(String testEnvironment, String firstName, String lastName, String emailID, String trackingId) {
