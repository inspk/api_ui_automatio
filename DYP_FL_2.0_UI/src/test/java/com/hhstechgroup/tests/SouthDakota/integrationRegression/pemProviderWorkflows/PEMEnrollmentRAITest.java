...
/**
 * This test class verifies the PEM Enrollment RAI workflow
 */
@Listeners(VideoListener.class)

public class PEMEnrollmentRAITest extends BaseClassUI {
    ...
    /**
     * This test registers a PEM provider, submits an enrollment request and RAIs and approves the enrollment.
     *
    ...
    public void approveRAIForPEMProvider(String testEnvironment, String testEmailAccount,String enrollmentType,
        ...
        //Provider resubmits the RAI request
