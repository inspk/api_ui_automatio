...
public class PEMEnrollingServicingProviderAndApprove extends BaseClassUI {
    ...
    public Object[][] testSearchFeature(ITestContext context) {
        ...
        return new Object[][]{
                {testEnvironment,Data.SERVICING_PROVIDER,
    ...
    /**
     * This test Login as an Active PEM provider, submits an enrollment request for Servicing Provider and approves the enrollment.
     *
    ...
    @Video
    @Test(dataProvider = "Enrollment type", groups =  {"PEMEnrollingServicingProvider"}
//            , dependsOnGroups = {"ApprovePEMProvider","EntityProviderApproved"}
    )
    public void pemEnrollingServicingProvider(String testEnvironment,String enrollmentType,
