...
/**
 * This class contains a test which uses a data provider to register a new Provider and, creates and Denies an ORP enrollment.
 */
public class ORPProviderDenyTest extends BaseClassUI {
    String npi;
    String zipCode;
    ...
    /**
     * This method registers a new Provider , creates and submits an ORP enrollment and denies. The flow is first deletes all
     ...
     * the sections and signs the enrollment. logs into DyP as an Internal User,executes a search for the enrollment,
     * denies the enrollment, logs out as the Internal User and writes the status of the enrollment to ProviderInfo.xlsx.
     ...
     */
    @Video
    @Test(dataProvider = "Enrollment type", groups =  {"DenialORPEnrollment"})
    public void denyORPEnrollment(String testEnvironment, String testEmailAccount,String enrollmentType, String newEmail, String firstName, String lastName,
        ...
        //UNDER SCREENING
        enrollmentPageInternalUser.enrollmentUnderScreen(testEnvironment,environmentUrl,firstName,lastName,trackingNumber,Data.statusPendingApproval);

        //Adding Pending Review Flow Per Configuration
      //  enrollmentPageInternalUser.pendingReviewFlowConfigaration(firstName,lastName,"PENDING APPROVAL",trackingNumber);
        ...
        enrollmentPageInternalUser.logOut();
        excel.writeTestData(testEnvironment,enrollmentType,firstName, lastName, newEmail, providerEmailPassword,taxonomy,npi, StatusOfApplication,trackingNumber);
        excel.readExcel();
